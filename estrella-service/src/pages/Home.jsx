          ...
          <div className='col-span-12 md:col-span-8 h-full w-full'>
            <article className='w-full flex flex-col items-start justify-center'>
              ...
              <p className='text-md font-serif mt-6 text-gray-800'>
                Somos una empresa familiar que ofrece una selección
                cuidadosamente seleccionada de villas y apartamentos
                vacacionales en y alrededor de la hermosa ciudad de Calpe en
                Alicante, España... Todos son exclusivos y la mayoría solo están
                disponibles en Estrella Service. También tendrá la seguridad de
                saber que tendrá su propio representante en su estancia
                vacacional.
              </p>
              <p className='text-md font-serif mt-6 text-gray-800'>
                {' '}
