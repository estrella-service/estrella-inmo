...
const PrivacyPolicyModal = () => {
  ...
  const isModalOpen = isOpen && type === 'aviso-legal';
  return (
    <Modal
      isOpen={isModalOpen}
      onClose={onClose}>
      <div className='max-w-4xl mx-auto p-6 bg-white shadow-lg rounded'>
        ...
        <p className='mb-4 text-sm md:text-lg'>
          ...
          documento mencionado en él) establece la base sobre la cual
          procesaremos cualquier dato personal que recopilemos de usted, o que
          usted nos proporcione. Al visitar{' '}
          <a
        ...
        <ol className='list-decimal pl-8 mb-4  text-sm md:text-lg'>
        ...
        <p className='mb-4  text-sm md:text-lg'>
          Nuestro sitio web utiliza cookies para distinguirlo de otros usuarios
          de nuestro sitio web. Esto nos ayuda a brindarle una buena experiencia
        ...
        <ul className='list-disc pl-8 mb-4 text-sm md:text-lg'>
          <li>
          ...
          <li>
            Para fines estadísticos internos para ayudarnos a evaluar nuestra
            gama de servicios;
          </li>
        ...
        <p className='mb-4 text-sm md:text-lg'>
          Usted acepta que tenemos derecho a compartir su información personal
          con ciertos terceros mencionados en el documento.
        </p>
