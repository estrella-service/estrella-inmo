  ...
  return (
    <div className='w-full flex flex-col items-center justify-center p-2 mt-4 border border-gray-400 rounded-md '>
      <div className='w-full mt-2'>
        <h2 className='text-2xl font-serif text-gray-800 flex items-center justify-center gap-4'>
        ...
        <div className='flex flex-col items-center justify-center gap-1 mt-4'>
          <label
            htmlFor='bedrooms'
            className='block text-sm font-medium  text-gray-900 w-full text-start'>
            Bedrooms Nº
          </label>
